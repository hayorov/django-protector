...
class GenericUserToGroup(models.Model):
    ...
    group_id = models.TextField(verbose_name=_('group id'))
...
class Restriction(MPTTModel, models.Model):
    ...
    """
    object_id = models.TextField(verbose_name=_('object id'), blank=False, null=False)
    content_type = models.ForeignKey(
...
class Restricted(models.Model):
    ...
    restriction_id = models.TextField(
